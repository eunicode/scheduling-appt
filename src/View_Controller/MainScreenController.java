...
public class MainScreenController implements Initializable {
    ...
    void reportTableHandler(ActionEvent event) throws IOException {
        ...
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        Object scene = FXMLLoader.load(getClass().getResource("/View_Controller/GenerateReport.fxml"));
        stage.setScene(new Scene((Parent) scene));
        stage.show();
    }
    ...
    private void logoutHandler(ActionEvent event) throws IOException {
        ...
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        Object scene = FXMLLoader.load(getClass().getResource("/View_Controller/LoginScreen.fxml"));
        stage.setScene(new Scene((Parent) scene));
        stage.show();
    }
